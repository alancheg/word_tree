...
新程序的改进主要如下
1. 在节点中增加 weight 值
2. 在计算的过程中，weight 值的初始值主要是基于 tf-idf 值
    随后基于 tf-idf 进行判断
"""
# import gensim
# import numpy
# import r_tree.rtree_hdim.RTreeHdim
#
# # 对于满足要求的节点进行分裂
# # 依据词向量的值进行分裂，主要有两个问题
...
class RNode(object):
    ...
    """
    def __init__(self, mbr=None, level=0, index=None, father=None, weight=None):
        if mbr is None:
